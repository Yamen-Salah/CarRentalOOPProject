...
class MonthlyAutoRenewalRental extends Rentals {
    ...
    MonthlyAutoRenewalRental(int id, int userId, int vehicleId, LocalDate startDate, LocalDate endDate, boolean isActive,
